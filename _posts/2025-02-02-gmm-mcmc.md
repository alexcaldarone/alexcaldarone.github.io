...
The project was implemented using [PyMC](https://www.pymc.io/welcome.html), which by default implements most samplers, but not Gibbs sampling. In this post, I'll walk you through the derivation of the Gibbs Sampler for this model!
...
$$
\boxed{\mu_0 | \mu_k, \sigma^2_k, y_i, z_i \sim \mathcal{N}\left(\frac{b}{a}, \frac{1}{c}\right).}
$$
